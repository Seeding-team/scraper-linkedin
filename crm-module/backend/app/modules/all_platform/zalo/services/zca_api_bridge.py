...
# ─────────────────────────────────────────────────────────────────────────
# Phase 3 "Quản lý kênh & CSKH" (2026-09-23): 3 hàm port thêm từ app gốc,
# cần cho scan-group-members (get_zca_group_members_full) và bulk-send job_type
# "add_friend" (send_zca_friend_request/get_zca_friend_status, automation_worker.py) —
# copy nguyên từ linkedin_group_crawler, không đổi logic.
# ─────────────────────────────────────────────────────────────────────────
