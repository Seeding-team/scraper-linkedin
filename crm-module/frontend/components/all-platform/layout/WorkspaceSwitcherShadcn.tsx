 ...
 * Render cho admin (thấy hết workspace đã cấu hình) HOẶC non-admin có >1
 * workspace trong `allowedInstances` (migration 005 — admin gán qua "Quản lý
 * thành viên") — điều kiện render kiểm tra ở nơi gọi
 * (AllPlatformSidebarShadcn.tsx), component này chỉ lo phần LỌC danh sách
