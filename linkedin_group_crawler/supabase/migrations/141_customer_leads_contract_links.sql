-- ============================================================
-- Migration: 141_customer_leads_contract_links.sql
-- Vấn đề 2 (Note vấn đề CRM cho team dev, 2026-09): thay field đơn
-- "Link báo giá / hợp đồng" (last_attachment_url/name) bằng 2 khu vực
-- riêng, mỗi khu vực cho phép nhiều link (1 dự án có thể chia nhỏ nhiều
-- hợp đồng):
