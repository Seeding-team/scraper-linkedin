-- Port từ MAIN (linkedin_group_crawler/supabase/migrations/146_quote_issuer_company_payment_terms_sync.sql) — giữ cùng số để lịch sử migration khớp (clone đang dừng ở 144).
