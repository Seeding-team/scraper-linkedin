...
-- sang crm-cloudgate (DB self-host riêng của module này, KHÔNG phải Supabase
-- Cloud của MAIN) — số thứ tự 144 trùng MAIN chỉ là trùng hợp do 2 lịch sử
-- migration độc lập đang cùng dừng ở 143.
